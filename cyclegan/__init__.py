...
class Configs(BaseConfigs):
    ...
    # cyclic_loss_coefficient = 0
    # identity_loss_coefficient = 0
...
def train():
    ...
    ## Train Cycle GAN
    """
    trained_run_uuid = '8df099c0a0c811ee88a05cff35c18842'
...
def train1():
    ...
    # Calculate configurations.
    # It will calculate `conf.run` and all other configs required by it.
    experiment.configs(conf, {'dataset_name': 'real2mural'})
    conf.initialize()
...
def evaluate():
    ...
    trained_run_uuid = '52eb1b9d88fe11eebf5af077c319d74a'
    ...
    with experiment.start():
        ...
        dataset = ImageDataset('real2mural_mini', transforms_, 'test')
